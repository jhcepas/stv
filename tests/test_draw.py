...
def test_draw_collapsed():
    ...
    assert list(draw.DrawerCollapsed(t, zoom=(2, 2)).draw()) == [
        ...
        ['b', (0.0, 0.0, 751.0, 3.0), 'node', 'F', {}, []],
        ['b', (1.0, 0.0, 750.0, 3.0), 'node', 'A', {}, [0]],
        ['b', (101.0, 0, 650.0, 3.0), 'outline', '(collapsed)', {}, []]]

    assert list(draw.DrawerCollapsed(t).draw()) == [
        ['t', 'F', (0, 2.727272727272727), 2.5, 'name'],
        ['b', Box(0, 0, 751.0, 3.0), 'outline', '(collapsed)', {}, []]]
...
def test_draw_tree():
    ...
    assert elements == [
        ...
        ['b', (0.0, 0.0, 751.4761904761905, 3.0), 'node', 'F', {}, []],
        ['b', (1.0, 0.0, 750.4761904761905, 3.0), 'node', 'A', {}, [0]],
        ['b', (101.0, 1.0, 650.4761904761905, 2.0), 'node', 'E', {}, [0, 1]],
        ['b', (451.0, 2.0, 300.4761904761905, 1.0), 'node', 'D', {}, [0, 1, 1]],
        ['b', (451.0, 1.0, 250.47619047619048, 1.0), 'node', 'C', {}, [0, 1, 0]],
        ['b', (101.0, 0, 200.47619047619048, 1.0), 'node', 'B', {}, [0, 0]]]
    ...
    assert elements_circ == [
        ...
        ['b', (0.0, -3.141592643589793, 1499.9955818558524, 6.283185287179586),
              'node', 'F', {}, []],
        ['b', (1.0, -3.141592643589793, 1498.9955818558524, 6.283185287179586),
              'node', 'A', {}, [0]],
        ['b', (101.0, -1.0471975511965979, 1398.9955818558524, 4.188790194786391),
              'node', 'E', {}, [0, 1]],
        ['b', (451.0, 1.0471975511965974, 1048.9955818558524, 2.0943950923931958),
              'node', 'D', {}, [0, 1, 1]],
        ['b', (451.0, -1.0471975511965979, 949.1290317988714, 2.0943951023931953),
              'node', 'C', {}, [0, 1, 0]],
        ['b', (101.0, -3.141592643589793, 500.1966313430248, 2.0943950923931953),
              'node', 'B', {}, [0, 0]]]
