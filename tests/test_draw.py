...
def test_draw_tree():
    ...
    assert elements_circ == [
        ...
        ['s', (0.0, -3.1415926535897936, 1499.9955818558524, 6.283185307179586),
              'node', 'F', {}, []],
        ['s', (1.0, -3.1415926535897936, 1498.9955818558524, 6.283185307179586),
              'node', 'A', {}, [0]],
        ['s', (101.0, -1.0471975511965979, 1398.9955818558524, 4.1887902047863905),
              'node', 'E', {}, [0, 1]],
        ['s', (451.0, 1.0471975511965974, 1048.9955818558524, 2.0943951023931953),
              'node', 'D', {}, [0, 1, 1]],
        ['s', (451.0, -1.0471975511965979, 949.1290317988714, 2.0943951023931953),
              'node', 'C', {}, [0, 1, 0]],
        ['s', (101.0, -3.141592653589793, 500.1966313430248, 2.0943951023931953),
              'node', 'B', {}, [0, 0]]]
