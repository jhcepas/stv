...
def test_draw_collapsed():
    ...
    drawer_z10 = draw.DrawerCollapsed(t, zoom=(10, 10))
    assert not any(e[0] == 'b' and e[2] == 'outline' for e in drawer_z10.draw())

    drawer_z2 = draw.DrawerCollapsed(t, zoom=(2, 2))
    ...
    drawer_z1 = draw.DrawerCollapsed(t)
...
def test_draw_tree():
    ...
    assert elements == [
        ...
        ['box', (101.0, 0.0, 200.47619047619048, 1.0), 'B', {}, [0, 0]]]
