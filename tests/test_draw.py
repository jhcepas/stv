...
def test_draw_tree():
    ...
    # assert elements == [
        # ['line', (101.0, 0.5), (301.0, 0.5), '', []],
        # ['text', (301.0, 0.0, 0.6666666666666667, 1.0), (0, 0.5), 'B', 'name'],
        # ['line', (451.0, 1.5), (701.0, 1.5), '', []],
        # ['text', (701.0, 1.0, 0.6666666666666667, 1.0), (0, 0.5), 'C', 'name'],
        # ['line', (451.0, 2.5), (751.0, 2.5), '', []],
        # ['text', (751.0, 2.0, 0.6666666666666667, 1.0), (0, 0.5), 'D', 'name'],
