...
def test_draw_tree():
    ...
    assert elements == [
        ...
        ['r', 'node', 1.0, 0, 750.0, 3.0, 'A', {}, [0]],
        ['l', 101.0, 0.5, 301.0, 0.5],
        ['t', 'length', 101.0, 0.5, 5.0, '2e+02'],
        ['r', 'node', 101.0, 0, 200.0, 1.0, 'B', {}, [0, 0]],
